      ...
      <div className="container">
        ...
        <div className="row about-me p-3 pt-4 pb-4 justify-content-center">
          ...
          <div className="col-12 col-sm-6 col-lg-7 about-text">
            ...
            <p>I learned a lot of software development and management knowledge at the University of Dominguez Hills, but I realized I still needed actual applications developing experience. That&apos;s why I took the immersive program at LearningFuze later. New friends and new technologies made me excited. I spent ten hours per day for practice and developing applications over there. I am looking forward to the experiences in developing professional applications in the near future.</p>
